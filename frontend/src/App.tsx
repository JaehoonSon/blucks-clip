...
import { PromptResponse, TimeStamp, UploadVideoResponse } from "./Services/api";
...
function App() {
  ...
  const suggestedPrompts: SuggestedPrompt[] = [
    { id: "1", text: "Give me the most nerve-racking moments" },
    { id: "2", text: "Highlight moment" },
            ...
            <div className="flex gap-2 mb-4 overflow-x-auto pb-2">
              {suggestedPrompts.map((prompt) => (
                <button
                  ...
                  className="px-3 py-1 bg-blue-50 text-blue-600 rounded-full text-sm whitespace-nowrap hover:bg-blue-100 transition-colors"
                >
                  {prompt.text}
                </button>
              ))}
